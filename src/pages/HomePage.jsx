...
const APPLE_CAROUSEL_DATA = [
  ...
  // Agrega más objetos aquí para más tarjetas en el carrusel
];
...
function HomePage() {
  return (
    <div className="p-6 max-w-7xl mx-auto space-y-16 bg-white dark:bg-darkBase min-h-screen transition-colors duration-300">
      ...
      {/* Sección del 3D Card para Imagen Grande */}
      ...
      {/* Sección de Características (Memoria Histórica, Acceso Seguro, Contenido Validado) */}
      ...
      {/* Sección del Carrusel de Tarjetas Estilo Apple */}
      <section className="my-12 md:my-20 w-full">
        ...
        {/* El componente AppleCarousel maneja su propio max-width por defecto */}
        <AppleCarousel items={appleCarouselItems} />
      </section>

      {/* Sección Final "Empieza tu recorrido..." */}
